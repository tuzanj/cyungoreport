...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateCsrfToken($_POST['csrf_token'] ?? '')) {
        setFlash('danger', 'Invalid CSRF token.'); redirect('/admin/notifications.php');
    }
...
if (isset($_GET['mark_all'])) { $notifModel->markAllRead(currentUserId()); redirect('/admin/notifications.php'); }
if (isset($_GET['id']))       { $notifModel->markRead((int)$_GET['id'], currentUserId()); redirect('/admin/notifications.php'); }
